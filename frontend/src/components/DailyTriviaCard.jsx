...
export function DailyTriviaCard() {
  ...
  return (
    <div className="relative overflow-hidden bg-[var(--sh-card-base)] card-pop rounded-2xl border border-shBorder shadow-2xl" data-testid="daily-trivia-card">
        ...
        {!answered ? (
          <div className="flex items-center justify-between mt-4 flex-wrap gap-2">
            ...
            <button onClick={submit} disabled={chosen === null || submitting}
                    ...
                    className="bg-shSecondary text-bgHeader px-4 min-h-[44px] py-2 rounded text-[12px] font-black uppercase tracking-widest disabled:opacity-40">
