...
export default function WaiverModal({ waiverText, version, dogNames, onSigned, onClose, allowClose=false }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/90 flex items-center justify-center p-4 z-50" data-testid="waiver-modal">
      <div className="border border-shBorder rounded-2xl w-full max-w-3xl p-6 md:p-8 shadow-sh max-h-[calc(var(--app-height)_-_1rem)] overflow-y-auto animate-slide-in card-waiver" style={{ background: "var(--sh-card-base)" }}>
