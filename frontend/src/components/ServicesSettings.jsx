...
const emptyService = { name: "", description: "", base_price: 0, service_type: "other", color: "#64748b", icon: "fa-tag", duration_minutes: 60, capacity_per_slot: 1, active: true, is_addon: false, addon_for: [], package_program_id: "" };
