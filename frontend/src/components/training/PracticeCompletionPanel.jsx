    ...
    <div className="space-y-4 sm:space-y-5" data-testid={testid}>
      ...
      {onAskSubmit && (
        <SectionCard accent="purple" intensity="subtle">
          <p className="text-[10px] font-black uppercase tracking-[0.14em] text-purple-300 mb-1">Need help from your trainer?</p>
          <p className="text-[11.5px] text-shTextMuted mb-2">Ask a question about what happened during this practice.</p>
