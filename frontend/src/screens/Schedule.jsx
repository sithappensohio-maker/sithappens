  ...
  return (
    <div className="h-full flex flex-col gap-3 animate-slide-in" data-testid="schedule-calendar">
      <div className="flex items-center justify-between">
        <p className="text-[14px] text-gray-500 font-black uppercase tracking-widest"><i className="fas fa-arrows-up-down-left-right mr-2 text-shBlue"/>Drag any event to reschedule it</p>
        {msg && <span className="text-[14px] font-black uppercase tracking-widest text-shGreen bg-shGreen/10 px-3 py-1 rounded">{msg}</span>}
      </div>
